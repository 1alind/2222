...
<head>
    ...
    <title>Terms of Service - <?php echo htmlspecialchars($settings['storeName']); ?></title>
...
<body>
    <div class="container">
        ...
        <div class="page-content">
            <h2 id="lang-termsTitle" style="margin-bottom: 20px;">Terms of Service</h2>
            <p id="lang-termsContent">Welcome to 22 Show. By accessing or using our services, you agree to comply with our terms. All products are subject to availability. Prices and availability may change at any time. Delivery services are available across Iraq. If you have any disputes, please contact us directly.</p>
